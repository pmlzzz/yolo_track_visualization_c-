...
<body>
<div id="videodiv">
<video id="video" width="900"  src="./test.webm" controls="controls">
...
console.log("pointnum",allpoints.length)
console.log("framenum",framestate.length)
console.log("blobsnum",blobsnum)
...
var div = d3.select("body").append("div") 
 ...
 var brushg = svg.append("g")
  ...
  function brushmove() {
      ...
      dragit.time.current=(brush.extent()[0]/framenum)*79;
...
var mainsvg = d3.select("#viz").append("svg")
                           .attr({width: (width+100)*2, height:height+5})
                           .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
var rect=mainsvg
            .append("rect")
            .attr("x",2)
...
var circleaxis = svg.selectAll(".circleaxis")
                .data(axisR)
                .enter()
                .append("circle")
